...
$message .= "http://mywebsite.com/activate.php?email=" . urlencode($email) . "&key=$activationKey";
if (mail($email, 'Confirm your Registration', $message, 'From:' . 'batricupid@gmail.com')) {
